...
// declare model used in controller
...
/**
 * Test/sample file for registration and server side validation proceedure.
 * 
 * This file is meant to establish standard way of coding. this sample uses server side validation with no javascript involved.
 */
class Login extends BaseController
{
    ...
    public function index()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            return $this->response->setJSON(['status' => 0, 'message' => 'Login Failed.']);
        }
