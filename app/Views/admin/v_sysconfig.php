		...
		<form class="row">
			...
			<div class="mb-3 col-md-6">
				...
				<div id="sys_desctext" class="form-text">输入说明 / Enter Description</div>
                        ...
                        <div class="mb-3 col-md-6">
				<label for="sys_desc" class="form-label">选择方式</label>
				<select class="form-control" id="select_method">
					<option selected disabled>-- 选择方式  --</option>
					<option value="1">上传图片</option>
					<option value="2">粘贴链接</option>
				</select>
			</div>
		
                        <div class="mb-3 col-md-6" id="upload_div" style="display:none;">
				<label for="photo" class="form-label">上传图片</label>
				<input type="file" class="form-control" id="photo" name="photo">
			</div>

			<div class="mb-3 col-md-6" id="link_div" style="display:none;">
