 ...
 */
class Userinfo8167Model extends Model
{
    protected $table      = 'userinfo_8167';
    ...
    protected $allowedFields = ['username', 'total_bet', 'vip_level'];
    ...
    public function get_datatable_data(int $limit = 0, int $offset = 0, string $orderby = null, string $orderdir = 'ASC', string $search = null )
    {
        ...
        $dataset->select('id, username, total_bet, vip_level, created_at, updated_at');
        ...
        if($search != null)
        {
            ...
            $dataset->orLike('total_bet', $search);
